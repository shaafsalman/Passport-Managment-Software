...
using PassportManagmentOffice.Forms;
using PassportManagmentOffice.Config;

namespace PassportManagmentOffice
{
    public partial class LoginPage : Form
    {
        ...
        private readonly string connectionString = "Data Source = SS-PAVILION; Database = PassportManagmentDB; trusted_connection = true";
